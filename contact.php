				...
				<div class="col-lg-6 w3layouts_mail_grid_left">
					<div class="agileits_mail_grid_left">
						...
						<ul>
							...
							<li><label><i class="fas fa-envelope" aria-hidden="true"></i></label><a href="mailto:info@example.com">vivinmphotography@gmail.com</a> <a href="mailto:vivinmphotography@gmail.com"></a></li>
							<li><label><i class="fa fa-phone" aria-hidden="true"></i></label>+91 9036030154</li>
						</ul>
					</div>
				</div>
					...
					<form action="send.php" method="post">
						<div class="w3_agileits_contact_left">
							...
							<input type="submit" name="send" value="SEND MESSAGE">
							 ...
							 <div class="col-sm-4" style="height:10px;"></div>
				...
				<div class="social mb-4 text-center">
					<ul class="d-flex justify-content-start">
					    <!--<li class="mr-2"><a href="#"><span class="fab fa-facebook-f"></span></a></li>-->
						 <li class="mr-2"><a href="#"><span class="fab fa-instagram"></span></a></li>
